// Real backend contracts audited from:
// - fulfillment - 副本/src/main/java/com/example/demo/controller/QnAController.java
// - fulfillment - 副本/src/main/java/com/example/demo/controller/LampController.java
// - fulfillment - 副本/src/main/java/com/example/demo/controller/QrController.java
// - fulfillment - 副本/src/main/java/com/example/demo/controller/FulfillmentController.java
...
export type ElectronicOrderResponse = {
  order_id: string;
  trace_id: string;
  code: string;
  message?: string;
